...
public class Element {
  ...
  public static class Feature {
     ...
     * @return new Feature generated by input.
     */
     ...
     * 
     * @param toRaise Amount to modify Cost to Raise (e.g. 80 for +80%)
     * @param toMaintain Amount to modify Cost to Maintain (e.g. -40 for -40%)
     */

    
    public enum Type {
      Airborne, AllWeather, Disloyal, Fanatic, Flagship, Hero, 
      Hovercraft, Impetuous, Levy, Marine, Mercenary, // Neutralize, 
