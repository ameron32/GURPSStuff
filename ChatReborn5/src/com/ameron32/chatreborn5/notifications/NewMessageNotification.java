...
import com.ameron32.chatreborn5.R.drawable;
import com.ameron32.chatreborn5.R.string;
...
public class NewMessageNotification {
   ...
   * <p>
   * TODO: Customize this method's arguments to present relevant content in the
   * notification.
   * <p>
  ...
  public static void notify(final Context context, final String exampleString, final int number) {
    ...
    // Show an expanded list of items on devices running Android 4.1
    // or later.
    .setStyle(new NotificationCompat.InboxStyle().addLine(exampleItem).addLine(exampleItem).addLine(exampleItem).addLine(exampleItem).setBigContentTitle(title).setSummaryText("Dummy summary text"))
